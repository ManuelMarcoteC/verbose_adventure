...
public class TestingOps {
    ...
    private static final String csvpath = "src\\main\\resources\\datos.csv";
    ...
    public static void main(String[] args) {
        ...
        CsvOps.saveCustomersCsv(customers, csvpath);
        CsvOps.saveOrdersCsv(orders, csvpath);

        CsvOps.getRecords(csvpath);
    }
}
